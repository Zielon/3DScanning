...
void TrackerTest::cameraPoseTest(){
	...
	for (int i = 0; i < nIters; i++)
	{
		...
		/*std::cout << "Vertices: source: " << source->getPoints().size() << 
			" target: " << tracker_context->m_tracker->m_previous_point_cloud->getPoints().size() << std::endl;*/
	...
	std::cout << "Average ICP time:  " << 1000.0f * icp_time / nIters << " ms\n";
	std::cout << "Total ICP error:  " << 100.0f * final_error << " cm\n";
	std::cout << "Average ICP error:  " << 100.0f * avg_error / nIters << " cm\n";
	std::cout << "Total ICP displacement error:  " << 100.0f * displacement_error << " cm\n";
	std::cout << "Average ICP displacement error:  " << 100.0f * avg_displacement_error / nIters << " cm\n";
